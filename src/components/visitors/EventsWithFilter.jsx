...
const EventsWithFilter = ({ initialEvents }) => {
  ...
  return (
    <div className="min-h-screen mt-8 py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 via-white to-blue-50">
        ...
        >
          {[
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`px-5 py-2 rounded-md cursor-pointer text-sm font-medium transition-all duration-300 ${
                filter === status.id
