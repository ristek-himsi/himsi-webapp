    ...
    return (
        <form action={formAction} >
            {/* {state.message && <div>{state.message}</div>} */}
             <button 
             type='submit'
                className="px-3 py-1.5 bg-red-600 cursor-pointer text-white rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors flex items-center">
